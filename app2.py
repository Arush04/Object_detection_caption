...
def upload_file():
    if request.method == "POST":
        ...
        command = "python detect.py --weights yolov8n.pt --img 640 --conf 0.25 --source " + file_path + " --save-csv"
        os.system(command)
        ...
        return render_template('result.html',json_data=json.dumps(json_data), image_name=file.filename)
